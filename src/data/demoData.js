...
export const STORAGE_KEY = "blechroute-beta-021";
...
export function createDefaultState() {
  return {
    ...
    conversations: [
      {
        id: "chat-julia",
        participant: communityUsers[1],
        unread: 1,
        messages: [
          { id: 1, from: "Julia M.", text: "Der E39-Abendmoment ist richtig stark.", time: "18:42" },
          { id: 2, from: "Christoph", text: "Danke! War eine spontane Runde.", time: "18:45" }
        ]
      },
      {
        id: "chat-max",
        participant: communityUsers[2],
        unread: 0,
        messages: [
          { id: 1, from: "Max R.", text: "Fahren wir die Waldstraße am Wochenende?", time: "gestern" }
        ]
      }
    ],
